...
/* USER CODE BEGIN PFP */
MLX_data mlx_data;
calibration_settings calib_set;
calibration_settings slave_settings;
...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	set_gain(calib_set.gain);
	set_osr(calib_set.osr);
	set_filter(calib_set.dig_filter);
	set_resolution_X(calib_set.res_x);
	set_resolution_Y(calib_set.res_y);
	set_resolution_Z(calib_set.res_z);
